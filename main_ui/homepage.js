...
function initTabs(lang_config){
    ...
    for (let key in lang_config) {
        ...
        var text = "<button class='"+btn_class+"' id='"+btn_id+"' data-bs-toggle='tab' data-bs-target='#"+btn_target_id+"'   type='button' role='tab' aria-controls='"+btn_extension+"' aria-selected='true'>"+key+"</button>"
